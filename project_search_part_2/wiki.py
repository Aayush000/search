from constants import ADVANCED, ADVANCED_TO_QUESTION, BASIC, WIKI_API, ARTICLES, METADATA
import json
import re
import requests
...
def ask_advanced_search():
  ...
  answer = input(ADVANCED_TO_QUESTION[request]) if request != 5 and request != 7 else ''
